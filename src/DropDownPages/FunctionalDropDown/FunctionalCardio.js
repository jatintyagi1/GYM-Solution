...
import FunctionalCardioImage from '../../Assets/ImageArray/FunctionalCardio'

const FunctionalCardio = () => {
  return (
      ...
      <div className='functional-cardio-bottom-main-container'>
        ...
        <div className='functional-cardio-image-item-container'>
          <div className='functional-cardio-image-item-outer-wrapper'>
            {FunctionalCardioImage.map((image, index) => (
...
export default FunctionalCardio;